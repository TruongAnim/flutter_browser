...
import 'package:test_browser_2/material_transparent_page_route.dart';
...
class CustomPopupDialogPageRoute<T> extends MaterialTransparentPageRoute<T> {
  ...
  Duration get transitionDuration =>
      customTransitionDuration != null ? customTransitionDuration! : const Duration(milliseconds: 300);
...
class CustomPopupDialog extends StatefulWidget {
  ...
  const CustomPopupDialog({Key? key, required this.child, this.transitionDuration = const Duration(milliseconds: 300)})
      : super(key: key);
...
class _CustomPopupDialogState extends State<CustomPopupDialog> with SingleTickerProviderStateMixin {

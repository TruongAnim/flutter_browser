    ...
    var children = <Widget>[
      ...
      ElevatedButton.icon(
        ...
        label: RichText(
          text: const TextSpan(children: [
            ...
            TextSpan(text: "pichillilorenzo/flutter_inappwebview", style: TextStyle(color: Colors.blue))
          ]),
        ),
        onPressed: () {
          ...
          browserModel.addTab(WebViewTab(
            key: GlobalKey(),
            webViewModel: WebViewModel(url: WebUri("https://github.com/pichillilorenzo/flutter_inappwebview")),
          ));
      ...
      ElevatedButton.icon(
        ...
        label: RichText(
          text: const TextSpan(children: [
            TextSpan(text: "Github: ", style: TextStyle(color: Colors.black)),
            TextSpan(text: "pichillilorenzo/flutter_browser_app", style: TextStyle(color: Colors.blue))
          ]),
        ),
        onPressed: () {
          var browserModel = Provider.of<BrowserModel>(context, listen: false);
          browserModel.addTab(WebViewTab(
            key: GlobalKey(),
            webViewModel: WebViewModel(url: WebUri("https://github.com/pichillilorenzo/flutter_browser_app")),
          ));
          Navigator.pop(context);
        },
      ),

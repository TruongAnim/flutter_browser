...
import 'package:test_browser_2/models/search_engine_model.dart';
    ...
    var widgets = <Widget>[
      ...
      ListTile(
        ...
        subtitle: Text(settings.homePageEnabled
            ? (settings.customUrlHomePage.isEmpty ? "ON" : settings.customUrlHomePage)
            : "OFF"),
        onTap: () {
                          ...
                          children: <Widget>[
                            Expanded(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(hintText: 'Custom URL Home Page'),
        ...
        onChanged: (value) {
          setState(() {
            ...
            if (browserModel.webViewTabs.isNotEmpty) {
              ...
              webViewModel?.webViewController?.setSettings(settings: webViewModel.settings ?? InAppWebViewSettings());
              browserModel.save();
            }
          });
        },
      ...
      ListTile(
        leading: Container(
          ...
          child: const CircleAvatar(backgroundImage: AssetImage("assets/icon/icon.png")),
        ),
  ...
  List<Widget> _buildWebViewTabSettings() {
    ...
    var widgets = <Widget>[
      ...
      StatefulBuilder(
        builder: (context, setState) {
          return ListTile(
            ...
            subtitle: Text(currentWebViewModel.settings?.userAgent?.isNotEmpty ?? false
                              ...
                              Expanded(
                                child: TextField(
                                  onSubmitted: (value) async {
                                    currentWebViewModel.settings?.userAgent = value;
                                  ...
                                  decoration: const InputDecoration(hintText: 'Custom User Agent'),
      ...
      SwitchListTile(
        ...
        onChanged: (value) async {
          currentWebViewModel.settings?.mediaPlaybackRequiresUserGesture = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          currentWebViewModel.settings = await webViewController?.getSettings();
          browserModel.save();
          setState(() {});
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether the vertical scrollbar should be drawn or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether the horizontal scrollbar should be drawn or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether vertical scroll should be enabled or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether horizontal scroll should be enabled or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether context menu should be enabled or not."),
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.minimumFontSize.toString(),
      ...
      SwitchListTile(
        ...
        onChanged: (value) async {
          currentWebViewModel.settings?.allowUniversalAccessFromFileURLs = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          currentWebViewModel.settings = await webViewController?.getSettings();
          browserModel.save();
          setState(() {});

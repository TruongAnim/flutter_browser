...
import 'package:test_browser_2/models/browser_model.dart';
import 'package:test_browser_2/models/webview_model.dart';
import 'package:test_browser_2/multiselect_dialog.dart';
  ...
  List<Widget> _buildIOSWebViewSettings() {
    ...
    var widgets = <Widget>[
      ...
      SwitchListTile(
        ...
        subtitle:
            const Text("Sets whether the WebView should bounce when the scrolling has reached an edge of the content"),
        value: currentWebViewModel.settings?.disallowOverScroll ?? false,
        onChanged: (value) {
          currentWebViewModel.settings?.disallowOverScroll = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          browserModel.save();
          setState(() {});
        },
      ),
      SwitchListTile(
        ...
        subtitle:
            const Text("Enable to allow a viewport meta tag to either disable or restrict the range of user scaling."),
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.settings?.suppressesIncrementalRendering ?? false,
        onChanged: (value) {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.settings?.allowsAirPlayForMediaPlayback ?? true,
        onChanged: (value) {
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Enable to allow the horizontal swipe gestures trigger back-forward list navigations."),
        value: currentWebViewModel.settings?.allowsBackForwardNavigationGestures ?? true,
        onChanged: (value) {
          currentWebViewModel.settings?.allowsBackForwardNavigationGestures = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          browserModel.save();
          setState(() {});
        },
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.settings?.ignoresViewportScaleLimits ?? false,
        onChanged: (value) {
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Enable to allow HTML5 videos play picture-in-picture."),
        value: currentWebViewModel.settings?.allowsPictureInPictureMediaPlayback ?? true,
        onChanged: (value) {
          currentWebViewModel.settings?.allowsPictureInPictureMediaPlayback = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          browserModel.save();
          setState(() {});
        },
      ...
      ListTile(
        ...
        trailing: Container(
          ...
          child: Text(currentWebViewModel.settings?.dataDetectorTypes?.map((e) => e.toString()).join(", ") ?? ""),
        ),
        onTap: () async {
          ...
          if (dataDetectoryTypesSelected != null) {
            currentWebViewModel.settings?.dataDetectorTypes = dataDetectoryTypesSelected.toList();
            webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
            browserModel.save();
            setState(() {});
          }
      ...
      SwitchListTile(
        ...
        subtitle:
            const Text("Configures whether the scroll indicator insets are automatically adjusted by the system."),
        value: currentWebViewModel.settings?.automaticallyAdjustsScrollIndicatorInsets ?? false,
        onChanged: (value) {
          currentWebViewModel.settings?.automaticallyAdjustsScrollIndicatorInsets = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          browserModel.save();
          setState(() {});
        },
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether the WebView ignores an accessibility request to invert its colors."),
        value: currentWebViewModel.settings?.accessibilityIgnoresInvertColors ?? false,
        onChanged: (value) {
          currentWebViewModel.settings?.accessibilityIgnoresInvertColors = value;
          webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
          browserModel.save();
          setState(() {});
        },
      ...
      ListTile(
        ...
        subtitle: const Text("Determines the rate of deceleration after the user lifts their finger."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Sets whether the scroll-to-top gesture is enabled."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Determines whether paging is enabled for the scroll view."),
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.maximumZoomScale.toString(),
            keyboardType: const TextInputType.numberWithOptions(decimal: true),
            onFieldSubmitted: (value) {
              currentWebViewModel.settings?.maximumZoomScale = double.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              browserModel.save();
              setState(() {});
            },
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.minimumZoomScale.toString(),
            keyboardType: const TextInputType.numberWithOptions(decimal: true),
            onFieldSubmitted: (value) {
              currentWebViewModel.settings?.minimumZoomScale = double.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              browserModel.save();
              setState(() {});
            },
      ...
      ListTile(
        ...
        subtitle: const Text("Configures how safe area insets are added to the adjusted content inset."),
        trailing: DropdownButton<ScrollViewContentInsetAdjustmentBehavior>(
          onChanged: (value) {
            currentWebViewModel.settings?.contentInsetAdjustmentBehavior = value!;
            webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
            browserModel.save();
            setState(() {});
          },
          value: currentWebViewModel.settings?.contentInsetAdjustmentBehavior,
          items: ScrollViewContentInsetAdjustmentBehavior.values.map((decelerationRate) {
      ...
      SwitchListTile(
        ...
        subtitle:
            const Text("A Boolean value that determines whether scrolling is disabled in a particular direction."),
      ...
      ListTile(
        ...
        trailing: SizedBox(
          ...
          child: TextFormField(
            ...
            onFieldSubmitted: (value) {
              currentWebViewModel.settings?.mediaType = value.isNotEmpty ? value : null;
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              browserModel.save();
              setState(() {});
            },
      ...
      SwitchListTile(
        ...
        subtitle:
            const Text("Indicates if Apple Pay API should be enabled on the next page load (JavaScript won't work)."),
      ...
      ListTile(
        ...
        trailing: SizedBox(
            ...
            child: ElevatedButton(
              child: Text(
                currentWebViewModel.settings?.underPageBackgroundColor?.toString() ?? 'Pick a color!',
                style: const TextStyle(fontSize: 12.5),
              ),
              onPressed: () {
                showDialog(
                      ...
                      content: SingleChildScrollView(
                        child: ColorPicker(
                          ...
                          onColorChanged: (value) async {
                            currentWebViewModel.settings?.underPageBackgroundColor = value;
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Indicates whether text interaction is enabled or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Indicates whether fullscreen API is enabled or not."),
      ...
      SwitchListTile(
        ...
        subtitle: const Text("Indicates whether the web view's built-in find interaction native UI is enabled or not."),

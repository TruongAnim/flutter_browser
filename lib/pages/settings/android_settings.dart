  ...
  List<Widget> _buildAndroidWebViewTabSettings() {
    ...
    var widgets = <Widget>[
      ...
      const ListTile(
        ...
        subtitle:
            Text("Overrides the way the cache is used. The way the cache is used is based on the navigation type."),
      ),
      Container(
        padding: const EdgeInsets.only(left: 20.0, top: 0.0, right: 20.0, bottom: 10.0),
        alignment: Alignment.center,
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.defaultFixedFontSize.toString(),
            keyboardType: const TextInputType.numberWithOptions(),
            onFieldSubmitted: (value) async {
              currentWebViewModel.settings?.defaultFixedFontSize = int.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              currentWebViewModel.settings = await webViewController?.getSettings();
              browserModel.save();
              setState(() {});
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.defaultFontSize.toString(),
            keyboardType: const TextInputType.numberWithOptions(),
            onFieldSubmitted: (value) async {
      ...
      const ListTile(
        ...
        subtitle: Text("Disables the action mode menu items according to menuItems flag."),
      ),
      Container(
        padding: const EdgeInsets.only(left: 20.0, top: 0.0, right: 20.0, bottom: 10.0),
        alignment: Alignment.center,
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.minimumLogicalFontSize.toString(),
            keyboardType: const TextInputType.numberWithOptions(),
            onFieldSubmitted: (value) async {
              currentWebViewModel.settings?.minimumLogicalFontSize = int.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              currentWebViewModel.settings = await webViewController?.getSettings();
              browserModel.save();
              setState(() {});
      ...
      SwitchListTile(
        ...
        subtitle:
            const Text("Sets whether this WebView should raster tiles when it is offscreen but attached to a window."),
      ...
      Container(
        ...
        child: DropdownButton<VerticalScrollbarPosition>(
          ...
          items: VerticalScrollbarPosition.values.map((verticalScrollbarPosition) {
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.scrollBarDefaultDelayBeforeFade?.toString() ?? "0",
            keyboardType: const TextInputType.numberWithOptions(),
            onFieldSubmitted: (value) async {
              currentWebViewModel.settings?.scrollBarDefaultDelayBeforeFade = int.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              currentWebViewModel.settings = await webViewController?.getSettings();
              browserModel.save();
              setState(() {});
      ...
      ListTile(
        ...
        trailing: SizedBox(
          width: 50.0,
          child: TextFormField(
            initialValue: currentWebViewModel.settings?.scrollBarFadeDuration?.toString() ?? "0",
            keyboardType: const TextInputType.numberWithOptions(),
            onFieldSubmitted: (value) async {
              currentWebViewModel.settings?.scrollBarFadeDuration = int.parse(value);
              webViewController?.setSettings(settings: currentWebViewModel.settings ?? InAppWebViewSettings());
              currentWebViewModel.settings = await webViewController?.getSettings();
              browserModel.save();
              setState(() {});
      ...
      ListTile(
        ...
        trailing: SizedBox(
            ...
            child: ElevatedButton(
              child: Text(
                currentWebViewModel.settings?.verticalScrollbarThumbColor?.toString() ?? 'Pick a color!',
                style: const TextStyle(fontSize: 12.5),
              ),
              onPressed: () {
                showDialog(
                      ...
                      content: SingleChildScrollView(
                        child: ColorPicker(
                          ...
                          onColorChanged: (value) async {
                            currentWebViewModel.settings?.verticalScrollbarThumbColor = value;
      ...
      ListTile(
        ...
        trailing: SizedBox(
            ...
            child: ElevatedButton(
              child: Text(
                currentWebViewModel.settings?.verticalScrollbarTrackColor?.toString() ?? 'Pick a color!',
                style: const TextStyle(fontSize: 12.5),
              ),
              onPressed: () {
                showDialog(
                    ...
                    return AlertDialog(
                      content: SingleChildScrollView(
                        child: ColorPicker(
                          pickerColor: const Color(0xffffffff),
                          onColorChanged: (value) async {
                            currentWebViewModel.settings?.verticalScrollbarTrackColor = value;
                            webViewController?.setSettings(
                                settings: currentWebViewModel.settings ?? InAppWebViewSettings());
                            currentWebViewModel.settings = await webViewController?.getSettings();
                            browserModel.save();
      ...
      ListTile(
        ...
        trailing: SizedBox(
            ...
            child: ElevatedButton(
              child: Text(
                currentWebViewModel.settings?.horizontalScrollbarThumbColor?.toString() ?? 'Pick a color!',
                style: const TextStyle(fontSize: 12.5),
              ),
              onPressed: () {
                showDialog(
                    ...
                    return AlertDialog(
                      content: SingleChildScrollView(
                        child: ColorPicker(
                          pickerColor: const Color(0xffffffff),
                          onColorChanged: (value) async {
                            currentWebViewModel.settings?.horizontalScrollbarThumbColor = value;
                            webViewController?.setSettings(
                                settings: currentWebViewModel.settings ?? InAppWebViewSettings());
                            currentWebViewModel.settings = await webViewController?.getSettings();
                            browserModel.save();
      ...
      ListTile(
        ...
        trailing: SizedBox(
            ...
            child: ElevatedButton(
              child: Text(
                currentWebViewModel.settings?.horizontalScrollbarTrackColor?.toString() ?? 'Pick a color!',
                style: const TextStyle(fontSize: 12.5),
              ),
              onPressed: () {
                showDialog(
                    ...
                    return AlertDialog(
                      content: SingleChildScrollView(
                        child: ColorPicker(
                          pickerColor: const Color(0xffffffff),
                          onColorChanged: (value) async {
                            currentWebViewModel.settings?.horizontalScrollbarTrackColor = value;
                            webViewController?.setSettings(
                                settings: currentWebViewModel.settings ?? InAppWebViewSettings());
                            currentWebViewModel.settings = await webViewController?.getSettings();
                            browserModel.save();

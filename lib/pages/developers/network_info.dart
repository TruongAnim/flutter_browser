    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Selector<WebViewModel, List<LoadedResource>>(
          ...
          builder: (context, loadedResources, child) {
            ...
            listViewChildren.addAll(loadedResources.reversed.map((loadedResoruce) {
              ...
              return Row(children: <Widget>[
                InkWell(
                    onTap: () {
                      Clipboard.setData(ClipboardData(text: loadedResoruce.url!.toString()));
                    },
                    child: Container(
                ...
                Container(
                  ...
                  padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 2.5),
                  child: Text(domain, overflow: TextOverflow.ellipsis, style: textStyle),
                ),
                Container(
                  width: constraints.maxWidth / 4,
                  padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 2.5),

...
import 'package:test_browser_2/javascript_console_result.dart';
...
class _JavaScriptConsoleState extends State<JavaScriptConsole> {
  final TextEditingController _customJavaScriptController = TextEditingController();
      ...
      children: <Widget>[
        Flexible(
          child: Selector<WebViewModel, List<Widget>>(
            selector: (context, webViewModel) => webViewModel.javaScriptConsoleResults,
          ...
          child: Row(
            children: <Widget>[
              ...
              Selector<WebViewModel, List<String>>(
                  selector: (context, webViewModel) => webViewModel.javaScriptConsoleHistory,
                      ...
                      children: <Widget>[
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              if (currentJavaScriptHistory < 0) {
                                ...
                                _customJavaScriptController.text = javaScriptConsoleHistory[currentJavaScriptHistory];
                              }
                            },
                          ),
                        ),
                        SizedBox(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (currentJavaScriptHistory + 1 >= javaScriptConsoleHistory.length) {
                                currentJavaScriptHistory = javaScriptConsoleHistory.length;
  ...
  void evaluateJavaScript(String source) async {
    ...
    if (webViewModel != null) {
      ...
      webViewModel.addJavaScriptConsoleResults(JavaScriptConsoleResult(data: result.toString()));
      currentWebViewModel.updateWithValue(webViewModel);

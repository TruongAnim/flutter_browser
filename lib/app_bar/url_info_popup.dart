...
import 'package:test_browser_2/app_bar/certificates_info_popup.dart';
...
class UrlInfoPopup extends StatefulWidget {
  ...
  const UrlInfoPopup(
      {Key? key, required this.route, required this.transitionDuration, this.onWebViewTabSettingsClicked})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      children: <Widget>[
            ...
            return GestureDetector(
              ...
              child: Container(
                  ...
                  child: RichText(
                    ...
                    overflow: showFullInfoUrl ? TextOverflow.clip : TextOverflow.ellipsis,
                    text: TextSpan(
                      children: <TextSpan>[
                        TextSpan(
                            text: url?.scheme,
                        ...
                        TextSpan(text: url?.host, style: defaultTextSpanStyle.copyWith(color: Colors.black)),
        ...
        RichText(
            text: TextSpan(style: const TextStyle(fontSize: 12.0, color: Colors.black87), children: [
          TextSpan(
            text: "$text2 ",
          ),
          TextSpan(

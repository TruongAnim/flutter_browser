...
import 'package:test_browser_2/tab_viewer.dart';
import 'package:test_browser_2/app_bar/browser_app_bar.dart';
...
class _BrowserState extends State<Browser> with SingleTickerProviderStateMixin {
  static const platform = MethodChannel('com.pichillilorenzo.flutter_browser.intent_data');
  ...
  Widget _buildWebViewTabs() {
    return WillPopScope(
        ...
        child: Listener(
          ...
          child: Scaffold(appBar: const BrowserAppBar(), body: _buildWebViewTabsContent()),
        ));
  }
                    ...
                    Material(
                      ...
                      child: ListTile(
                        ...
                        title: Text(webViewTab.webViewModel.title ?? webViewTab.webViewModel.url?.toString() ?? "",
                            ...
                            style: TextStyle(
                              color:
                                  webViewTab.webViewModel.isIncognitoMode || isCurrentTab ? Colors.white : Colors.black,
                            ),
